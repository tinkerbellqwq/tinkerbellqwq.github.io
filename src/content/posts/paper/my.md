...
description: "师兄推荐的医学报告生成相关论文阅读笔记"
tags: ["论文", "医学", "深度学习", "报告生成"]
category: "论文阅读"
image: ""
draft: false
---
...
- 创新点：
    ...
    - 机制创新：提出了一个解耦的记忆对齐（Decoupled Memory Alignment）模块。它将特征表示（Representation）和对齐（Alignment）这两个任务分开，让记忆矩阵只专注于对齐，从而学习更纯粹的跨模态映射关系。
